...
public class LeaderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rvLeader = (RecyclerView) view.findViewById(R.id.rvLeader);

        LinearLayoutManager leaderLayoutManager= new LinearLayoutManager(view.getContext(), LinearLayoutManager.VERTICAL, false);

        rvLeader.setLayoutManager(leaderLayoutManager);
